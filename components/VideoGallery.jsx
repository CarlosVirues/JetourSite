...
export default function VideoGallery({
  ...
  return (
    <section className="relative bg-black text-white py-8 lg:py-16">
                ...
                >
                  <div className="relative h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden bg-gray-800">
                    ...
                    {videos[currentSlide]?.type === "video" ? (
                      // Show actual video for video type
                      <iframe
                        src={`https://www.youtube.com/embed/${getYouTubeVideoId(
                          videos[currentSlide]?.videoUrl
                        )}?autoplay=0&mute=1&loop=1&playlist=${getYouTubeVideoId(
                          videos[currentSlide]?.videoUrl
                        )}&controls=0&showinfo=0&rel=0&modestbranding=1`}
                        title={videos[currentSlide]?.title || "Video"}
                  ...
                  >
                    <div className="relative h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden bg-gray-800">
                      ...
                      "video" ? (
                        ...
                        <iframe
                          src={`https://www.youtube.com/embed/${getYouTubeVideoId(
                            videos[(currentSlide + 1) % videos.length]?.videoUrl
                          )}?autoplay=0&mute=1&loop=1&playlist=${getYouTubeVideoId(
                            videos[(currentSlide + 1) % videos.length]?.videoUrl
                          )}&controls=0&showinfo=0&rel=0&modestbranding=1`}
                          title={
