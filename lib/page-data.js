...
export const vehicleModelPagesData = {
  ...
  "dashing-phev": {
    hero: {
      backgroundImage: "/models/dashing-phev/dashing-phev.jpg",
        ...
        slides: [
          {
            backgroundImage: "/models/dashing-phev/dashing-phev.jpg",
            bullets: [
              "Sistema de audio Sony 8",
              "Encendido remoto del motor",
              "Control por voz Hello Jetour",
            ],
          },
        ],
      },
        ...
        slides: [
          {
            ...
            bullets: [
              "Asientos de cuero",
              "Volante de cuero con botones multifuncional",
              'Consola central de mando 12.8"',
            ],
          },
        ],
        ...
        slides: [
          {
            backgroundImage: "/models/dashing-phev/dashing-phev.jpg",
            bullets: [
              "Apoyabrazos central con refrigeración",
              "Purificadores de aire inteligente",
              "Climatizador bizona",
            ],
          },
        ],
    ...
    vehicleGallery: {
      ...
      images: [
        { id: 1, src: "/models/dashing-phev/dashing-phev.jpg", alt: "JETOUR Dashing PHEV vista exterior" },
        { id: 2, src: "/models/dashing-phev/dashing-phev.jpg", alt: "JETOUR Dashing PHEV lateral" },
        { id: 3, src: "/models/dashing-phev/dashing-phev.jpg", alt: "JETOUR Dashing PHEV diseño" },
        { id: 4, src: "/models/dashing-phev/dashing-phev.jpg", alt: "JETOUR Dashing PHEV detalle" },
      ],
    },
  },
  g700: {
