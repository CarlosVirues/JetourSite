...
export const vehicleModelPagesData = {
  t1: {
        ...
        slides: [
          {
            ...
            bullets: [
              ...
              "Llave inteligente con encendido remoto",
            ]
          },
        ]
      },
    ...
    specificationsVideo: {
      ...
      logoImage: "/models/t1/t1-logo.png",
      logoAlt: "T1 Logo",
      description: "SUV diseñado para el OFF ROAD extremo y urbano super premium"
    },
  },
  t2: {
    hero: {
    ...
    featureSlides: [
      ...
      },
      {
        ...
        slides: [
          {
            backgroundImage: "/models/t2/t2-features-5.1.jpg",
            bullets: [
              "Luces y Plumas automáticas",
            ]
          },
          {
            backgroundImage: "/models/t2/t2-features-5.2.jpg",
            bullets: [
              "Freno de Mano de botón",
              "Luces diurnas LED",
              "Retrovisores eléctricos plegables",
    ...
    specificationsVideo: {
      ...
      logoImage: "/models/t2/t2-logo.png",
      logoAlt: "T2 Logo",
      description: "Para conquistar todos los caminos, diseñado para el OFF ROAD extremo pero también para destacar en la ciudad"
    },
  ...
  "t2-phev": {
      ...
      },
      {
        ...
        slides: [
          ...
          },
          {
            ...
            bullets: [
              "USB A y C. Cargador Inalámbrico",
              "A/C de doble zona",
              "Asiento del piloto con regulación eléctrica con 3 memorias",
            ]
          },
        ...
        slides: [
          {
            ...
            bullets: [
              "Sistema ADAS (Advanced Driver Assistance System)",
              "Asistente para arranque en pendiente y control de descenso",
              "Frenos de disco con ABS y sistema de control de estabilidad y EBD",
              "Sistema de detección de punto ciego",
              "6 Airbags",
    ...
    specificationsVideo: {
      ...
      logoImage: "/models/t2-phev/t2-phev-logo.png",
      logoAlt: "T2 PHEV Logo",
      description: "SUV premium con capacidad de 1200 km de autonomía"
    },
  ...
  x50: {
    ...
    featureSlides: [
      ...
      },
      {
        ...
        slides: [
          {
            backgroundImage: "/models/x50/x50-features-2.1.jpg",
            bullets: [
  ...
  "x70-sport": {
        ...
        slides: [
          ...
          },
          {
            ...
            bullets: [
              "A/C con salidas delanteras y posteriores",
              "Control Velocidad Crucero",
              "Maletero capacidad 1260 litros",
    ...
    specificationsVideo: {
      ...
      logoAlt: "X70 Sport Logo",
      description: "El mejor vehículo para la familia"
    },
  ...
  dashing: {
    ...
    featureSlides: [
      ...
      },
      {
        ...
        slides: [
          ...
          {
            backgroundImage: "/models/dashing/dashing-features-4.2.jpg",
            bullets: [
              "Freno de mano de botón",
            ]
          },
    ...
    specificationsVideo: {
      ...
      logoImage: "/models/dashing/dashing-logo.png",
      logoAlt: "Dashing Logo",
      description: "Un diseño futurista y tecnológico"
    },
  ...
  g700: {
    hero: {
      ...
      highlights: [
        ...
        {
          id: 4,
          text: "+1400 km Autonomía combinada",
        }
      ]
    },
    vehicleGallery: {
    ...
    specificationsVideo: {
      ...
      logoImage: "/models/g700/g700-logo.png",
      logoAlt: "G700 Logo",
      description: "4x4 con una potencia única y un lujo incomparable para una experiencia off-road que ningún otro carro te ofrece"
    },
  ...
  "t1-phev": {
        ...
        slides: [
          {
            ...
            bullets: [
              ...
              "Sistema de detección de punto ciego",
              "6 Airbags",
              "Cámara de Retro 540°. Sensores delanteros y traseros",
            ]
          },
        ]
      },
    ...
    specificationsVideo: {
      ...
      logoAlt: "T1 PHEV Logo",
      description: "SUV urbano y off road premium que todos te admiran"
    },
  },
};
