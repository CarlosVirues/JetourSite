...
export const vehicleModelPagesData = {
  ...
  "t2-phev": {
    hero: {
      ...
      backgroundVideo: "https://storage.googleapis.com/xiyimgengine/jetour/hero/banner-t2-phev.mp4",
      vehicleName: "T2 PHEV",
      ...
      highlights: [
        {
          id: 1,
          text: "+ 1200 Km Autonomía por tanqueada"
        },
        {
          id: 2,
        ...
        {
          id: 4,
          text: "Transmisión Híbrido 3 DHT"
        }
      ]
    },
    features: {
  ...
  "x70-sport": {
    hero: {
      ...
      highlights: [
        ...
        {
          id: 3,
          text: "1.5 Turbo versiones 6 velocidades manual y 6 DCT Automático"
        },
        {
          id: 4,
    ...
    // Ficha técnica disponible
    technicalSheet: true,
    // NO tiene video de especificaciones
  ...
  "x70-plus": {
    hero: {
      ...
      highlights: [
        ...
        {
          id: 3,
          text: "1.5 Turbo 160 HP transmisión 6 DCT Automático"
        },
        {
          id: 4,
          text: "Doble Pantalla 10.25\" + 10.25\""
        }
      ]
    },
    features: {
  ...
  dashing: {
    ...
    // Video de especificaciones
    specificationsVideo: {
      videoUrl: "https://storage.googleapis.com/xiyimgengine/jetour/especificaciones/especificaciones-dashing.mp4",
      title: "Especificaciones técnicas",
      model: "Dashing"
    },
