    ...
    featureSlides: [
      {
        ...
        slides: [
          {
            backgroundImage: "/models/x70-plus/x70-plus-features-1.1.jpg",
            bullets: [
              "4 Airbags",
              "Asistente para arranque en pendiente",
            ]
          ...
          {
            backgroundImage: "/models/x70-plus/x70-plus-features-1.2.jpg",
            bullets: [
              "Frenos de disco con ABS y sistema de control de estabilidad",
              "Sistema de detección de punto ciego",
              "Cámara de Retro 360° más sensores delanteros y traseros",
      ...
      },
      {
        ...
        slides: [
          {
            backgroundImage: "/models/x70-plus/x70-plus-features-2.1.jpg",
            bullets: [
      ...
      },
      {
        ...
        slides: [
          {
            backgroundImage: "/models/x70-plus/x70-plus-features-3.1.jpg",
            bullets: [
              "Asientos de Cuero",
            ]
          },
          {
            backgroundImage: "/models/x70-plus/x70-plus-features-3.2.jpg",
            bullets: [
              "A/C Con salidas delanteras y posteriores",
            ]
          },
          {
            backgroundImage: "/models/x70-plus/x70-plus-features-3.3.jpg",
            bullets: [
              "Volante ajustable con mandos multifunción",
            ]
          },
          {
            backgroundImage: "/models/x70-plus/x70-plus-features-3.4.jpg",
            bullets: [
