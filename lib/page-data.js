...
export const vehicleModelPagesData = {
  ...
  f700: {
    hero: {
      backgroundImage: "/models/f700/f700-color-grey-matte.png", // Placeholder: no se entregó banner/video de hero
      backgroundVideo: null,
      vehicleName: "F700",
      vehicleDescription: "Potencia, tecnología y autonomía para llegar más lejos.",
      height: "h-screen",
      logoImage: null, // Pendiente: no se entregó logo del modelo
      logoAlt: "F700",
      highlights: [
