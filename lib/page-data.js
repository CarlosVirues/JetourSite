...
export const vehicleModelPagesData = {
  ...
  "t2-phev": {
    ...
    videoGallery: {
      title: "Mira el JETOUR T2 PHEV 4X4 en Acción",
      videos: [
        {
          id: 1,
          title: "Test Drive JETOUR T2 PHEV 4X4 - Tecnología Híbrida",
        ...
        {
          id: 2,
          title: "Características del JETOUR T2 PHEV 4X4",
          thumbnail: "/models/t2-phev/t2-phev-video-1.jpg",
      ...
      images: [
        {
          ...
          alt: "JETOUR T2 PHEV 4X4 vista frontal",
        },
        {
          id: 2,
          src: "/models/t2-phev/t2-phev-gallery-2.jpg",
          alt: "JETOUR T2 PHEV 4X4 vista lateral",
        },
        {
          id: 3,
          src: "/models/t2-phev/t2-phev-gallery-4.jpg",
          alt: "Maletero JETOUR T2 PHEV 4X4",
        },
        {
          id: 4,
          src: "/models/t2-phev/t2-phev-gallery-5.jpg",
          alt: "Asientos JETOUR T2 PHEV 4X4",
        },
        {
          id: 5,
    ...
    // Sección 360° del modelo T2 PHEV 4X4
    threeSixty: {
      model: "t2-phev",
      totalFrames: 27,
      title: "Vista 360° del T2 PHEV 4X4",
      subtitle:
        "Arrastra para rotar el vehículo o usa los controles de navegación",
      imagePath:
    ...
    // Selector de colores del modelo T2 PHEV 4X4
    vehicleColors: {
      model: "t2-phev",
    ...
    // Secciones específicas del modelo T2 PHEV 4X4
  },
  x50: {
    hero: {
  ...
  "t1-phev": {
    ...
    // 360° entregado por Jetour el 2026-09-01 junto con los colores. El T1 PHEV tampoco
    // tenía este módulo (`threeSixty` ausente acá y null en Sanity). Los 72 frames vienen
    // a 4000×2250 y se sirven reescalados a 1600×900, igual que el F700 — el único otro
    // modelo self-hosted; el resto sigue apuntando al bucket GCS de devxiy.
    // El componente arma el nombre como `${imagePath}/${i}.png` (1..totalFrames, sin padding).
    threeSixty: {
      model: "t1-phev",
      totalFrames: 72,
      title: "Vista 360° del T1 PHEV",
      subtitle:
        "Arrastra para rotar el vehículo o usa los controles de navegación",
      imagePath: "/models/t1-phev/360",
      showInstructions: true,
    },
    // Colores entregados por Jetour el 2026-09-01 (correo "colores para la MOV de T1").
    // El T1 PHEV era el ÚNICO modelo del catálogo sin selector de color: `vehicleColorsNew`
    // estaba ausente acá y null en Sanity, así que esto lo agrega por primera vez.
    // Nomenclatura en español y Title Case, igual que los otros 10 modelos.
    // Los hex de Blanco/Negro/Plata se reusan del F700 (misma paleta de fábrica y mismo
    // pipeline de render). "Crema" se midió neutro en el render (#A7A7A5) y se calentó a
    // #A5A08F para que el swatch se distinga de Plata en el selector — a confirmar con Verónica.
    // FALTA "Plomo Mate": el cliente lo marcó PENDIENTE en el correo.
    vehicleColorsNew: {
      modelName: "T1 PHEV",
      colors: [
        {
          name: "Blanco",
          hex: "#D8D9DA",
          image: "/models/t1-phev/t1-phev-color-blanco.png"
        },
        {
          name: "Negro",
          hex: "#1A1B1F",
          image: "/models/t1-phev/t1-phev-color-negro.png"
        },
        {
          name: "Crema",
          hex: "#A5A08F",
          image: "/models/t1-phev/t1-phev-color-crema.png"
        },
        {
          name: "Plata",
          hex: "#9BA0A8",
          image: "/models/t1-phev/t1-phev-color-plata.png"
        }
      ]
    },
    featureSlides: [
  ...
  f700: {
    ...
    // Selector de colores nuevo
    vehicleColorsNew: {
      // Nombres en español confirmados por Verónica Vergara (2026-08-12): el cliente
      // simplificó la nomenclatura. Los 10 modelos restantes ya usaban español en Title
      // Case ("Plomo Mate" en G700 y T2 PHEV 4X4), así que esto alinea al F700 con el catálogo.
      // Los nombres de archivo conservan la nomenclatura inglesa original a propósito.
      modelName: "F700",
      colors: [
        {
          name: "Plata",
