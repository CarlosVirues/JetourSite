...
export const vehicleModelPagesData = {
  t1: {
    ...
    vehicleGallery: {
      title: "Galería del JETOUR T1",
      subtitle: "Descubre cada detalle del T1 en imágenes",
      images: [
        {
          id: 1,
  ...
  x50: {
    ...
    vehicleGallery: {
      title: "Galería del JETOUR X50",
      subtitle: "Descubre cada detalle del X50 en imágenes",
      images: [
        {
          id: 1,
