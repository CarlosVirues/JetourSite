...
export const vehicleModels = {
  ...
  "t2-phev": {
    ...
    description:
      "El JETOUR T2 PHEV 4X4 combina la eficiencia de un motor híbrido con la potencia que necesitas para cualquier viaje.",
    features: [
  ...
  g700: {
    ...
    description:
      "Rendimiento Todoterreno Excepcional",
    features: [
      "Integración Todoterreno",
      "Asistente de IA a Bordo",
  ...
  "dashing-phev": {
    ...
    description:
      "Un SUV urbano con estilo, tecnología híbrida enchufable y una autonomía combinada de 1200 km.",
    features: [
      "Potencia combinada 360 HP",
      "Autonomía combinada 1200 km",
      "Tecnología híbrida plug-in",
      "Diseño en tendencia",
    ],
  },
...
export function getVehicleModel(modelKey) {
  ...
  return vehicleModels[key] || vehicleModels.t1;
}
