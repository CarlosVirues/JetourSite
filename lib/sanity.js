...
// - Si projectId/dataset están ausentes (env vars no inyectadas, previews sin secrets,
//   builds locales sin .env), evitamos que createClient tire un ConfigurationError
//   sincrónico que rompa el build entero.
