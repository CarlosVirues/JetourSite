# Migración Jetour Ecuador — Status a 2026-05-28
...
## 2. Acciones técnicas listas para ejecutar (sin bloqueantes)

```bash
# 1. Migrar vehículos a Sanity production (requiere confirmación "yes" interactiva)
cd /Users/elsarito/Jeteour/jetour-site
npm run migrate-vehicles -- --dataset=production

# 2. Verificar en Sanity Studio
npm run dev   # → http://localhost:3000/studio

# 3. Lighthouse local antes de staging
...
*Generado 2026-05-28. Mantener sincronizado con [CLAUDE.md §10–§11](./CLAUDE.md).*
